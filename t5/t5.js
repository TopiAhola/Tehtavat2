...
/*
testMarker.bindPopup("<h3>Hello world!</h3><p>I am a popup.</p>").openPopup();*/
//let testPopup = L.popup().setContent("<h3>Hello world!</h3><p>I am a popup.</p>").openOn(map);
//testMarker.bindPopup(testPopup);
//testMarker.on('click', (e) => {testPopup.openPopup()});
